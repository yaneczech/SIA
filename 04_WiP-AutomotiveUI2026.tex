...
\begin{figure}[h]
  ...
  \vspace{2em}}}
  \caption{Mediation architecture. Trust and Context are cross-cutting policy
    functions; the Ontology Language is the canonical source of meaning.}
...
\begin{figure}[h]
  ...
  \fbox{\parbox{0.92\columnwidth}{\centering\vspace{2em}
    ...
    Insert PDF export of Mermaid diagram here.]}
  \vspace{2em}}}
  \caption{Four primary node types; Event splits into Alert and Notification.}
  \label{fig:taxonomy}
\end{figure}
...
\begin{figure}[h]
  ...
  \vspace{2em}}}
  \caption{Sequence flow. Trust Policy is a chokepoint before Translation.}
  \label{fig:sequence}
\end{figure}
...
\begin{enumerate}
  ...
  \item \emph{Reference implementation.} A prototype integrated with Eclipse
    Kuksa or uProtocol~\cite{eclipsesdv} would provide concrete grounding for
    further specification work and community evaluation.
\end{enumerate}
